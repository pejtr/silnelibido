  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col font-sans text-slate-900 bg-[oklch(0.22_0.08_275)]">
        ...
        <button
          className={`fixed bottom-20 md:bottom-8 right-2 md:right-8 rounded-full w-12 h-12 p-0 shadow-xl transition-all duration-300 z-50 bg-[#D32F2F] md:hover:bg-[#B71C1C] touch-manipulation text-white flex items-center justify-center cursor-pointer active:scale-95 ${

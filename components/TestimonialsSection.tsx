...
export function TestimonialsSection() {
  const baseAffiliateLink = "https://www.proerecta.cz/reference/?utm_medium=affiliate&utm_campaign=affial.com&utm_source=pap&a_aid=5d5a767017fee&a_bid=fd5e6b0c";
  const { url: affiliateLink, trackClick } = useAffiliateLink(baseAffiliateLink);
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-12 md:mb-16">
          ...
          <div className="flex items-center justify-center -space-x-4 mb-8">
            <div className="w-16 h-16 rounded-full border-4 border-white overflow-hidden shadow-lg bg-slate-200 flex items-center justify-center">
              <User className="w-8 h-8 text-slate-400" />
            </div>
            <div className="w-16 h-16 rounded-full border-4 border-white overflow-hidden shadow-lg z-10 bg-slate-200 flex items-center justify-center">
              <User className="w-8 h-8 text-slate-400" />
            </div>
            <div className="w-16 h-16 rounded-full border-4 border-white overflow-hidden shadow-lg z-20 bg-slate-200 flex items-center justify-center">
              <User className="w-8 h-8 text-slate-400" />
            </div>
          ...
          <a 
            href={affiliateLink} onClick={trackClick}

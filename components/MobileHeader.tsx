...
export function MobileHeader() {
  ...
  const { url: affiliateLink, trackClick: trackMobileClick } = useAffiliateLink(baseAffiliateLink);
  ...
  const { url: womenLink } = useAffiliateLink("https://www.proerecta.cz/produkt/proerecta-women/?utm_medium=affiliate&utm_campaign=affial.com&utm_source=pap&a_aid=5d5a767017fee&a_bid=fd5e6b0c");
  ...
  return (
    <div className="md:hidden">
      ...
      <div className="bg-white px-4 py-3 flex items-center justify-between relative z-50">
        ...
        <a href={affiliateLink} onClick={() => { vibrate(); trackMobileClick(); }} className="flex-shrink-0">
          <Image 
            src="/images/logo.svg" 
            alt="Proerecta" 
            width={150}
        ...
        <a href={affiliateLink} onClick={() => { vibrate(); trackMobileClick(); }} className="flex flex-col items-center gap-1 text-[#D32F2F] relative">

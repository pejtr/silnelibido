        ...
        <div className="container mx-auto px-4 md:px-8 mt-0 md:mt-16 relative z-10 pt-12 pb-24 md:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:flex relative h-[500px] md:h-[600px] w-full items-center justify-center lg:justify-end">
              ...
              {/* Couple Image (Masked) */}
              <div className="relative w-[350px] h-[350px] md:w-[450px] md:h-[450px] rounded-full overflow-hidden border-8 border-white shadow-2xl z-0 mr-12 md:mr-24 flex items-center -translate-x-[63px]">
                <img 
                  src="/images/hero-couple.jpg" 
                  alt="Happy Couple" 

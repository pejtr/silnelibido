...
export function HeroSection() {
  ...
  return (
    <div className="bg-white relative pb-0 md:pb-0">
      ...
      <a 
        href="#products" 
        className={`fixed top-[60%] -translate-y-1/2 left-0 z-[9999] transition-all duration-500 active:scale-95 hover:scale-105 group opacity-80 hover:opacity-100 ${showGift ? 'translate-x-0' : '-translate-x-full'}`}
      >
      ...
      <button 
        ...
        className={`fixed top-[60%] -translate-y-1/2 left-0 z-[9999] transition-all duration-500 active:scale-95 hover:scale-105 group opacity-80 hover:opacity-100 ${showQuiz ? 'translate-x-0' : '-translate-x-full'}`}

      ...
      <div className="hidden md:flex container mx-auto px-4 md:px-8 py-6 items-center justify-between relative z-20">
        ...
        <nav className="hidden lg:flex items-center gap-8 font-bold text-[#2A2A5A] text-sm uppercase tracking-wide">
          <div className="flex items-center gap-6">
            <a href="https://www.proerecta.cz/produkty/?utm_medium=affiliate&utm_campaign=affial.com&utm_source=pap&a_aid=5d5a767017fee&a_bid=fd5e6b0c" className="hover:text-[#D32F2F] transition-colors flex items-center gap-2 group">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-11 h-11 text-[#1E3A8A] group-hover:text-[#D32F2F] transition-colors"><path d="M9,9C10.29,9 11.5,9.41 12.47,10.11L17.58,5H13V3H21V11H19V6.41L13.89,11.5C14.59,12.5 15,13.7 15,15A6,6 0 0,1 9,21A6,6 0 0,1 3,15A6,6 0 0,1 9,9M9,11A4,4 0 0,0 5,15A4,4 0 0,0 9,19A4,4 0 0,0 13,15A4,4 0 0,0 9,11Z" /></svg>
              PRO MUŽE <span className="text-lg font-black text-yellow-400 group-hover:translate-x-1 transition-transform">›</span>
            </a>
            <a href="https://www.proerecta.cz/produkt/proerecta-women/?utm_medium=affiliate&utm_campaign=affial.com&utm_source=pap&a_aid=5d5a767017fee&a_bid=fd5e6b0c" className="hover:text-[#D32F2F] transition-colors flex items-center gap-2 group">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-11 h-11 text-[#F472B6] group-hover:text-[#D32F2F] transition-colors"><path d="M12,4A6,6 0 0,1 18,10C18,12.97 15.84,15.44 13,15.92V18H15V20H13V22H11V20H9V18H11V15.92C8.16,15.44 6,12.97 6,10A6,6 0 0,1 12,4M12,6A4,4 0 0,0 8,10A4,4 0 0,0 12,14A4,4 0 0,0 16,10A4,4 0 0,0 12,6Z" /></svg>
              PRO ŽENY <span className="text-lg font-black text-yellow-400 group-hover:translate-x-1 transition-transform">›</span>
            </a>
          </div>

    ...
    <div className="md:hidden">
      ...
      <div className={`w-full bg-[#D32F2F] flex flex-col justify-center items-center shadow-md transition-all duration-300 z-[40] ${isSticky ? 'fixed top-0 left-0 w-full' : 'sticky top-0'}`}>
         <div className="w-full flex justify-center items-center gap-8 py-3 px-4">
           <a href="https://www.proerecta.cz/produkty/" onClick={vibrate} className="text-white font-bold text-base uppercase tracking-wide flex items-center gap-2 hover:scale-110 transition-transform">
           ...
           <a href="https://www.proerecta.cz/produkt/proerecta-women/" onClick={vibrate} className="text-white font-bold text-base uppercase tracking-wide flex items-center gap-2 hover:scale-110 transition-transform">

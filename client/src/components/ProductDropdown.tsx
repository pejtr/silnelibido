        ...
        <div className="bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden p-6">
          <div className="grid grid-cols-2 gap-4">
            {products.map((product) => (
              ...
              >
                <div className="w-16 h-16 flex-shrink-0 bg-white rounded-md border border-gray-100 p-1 flex items-center justify-center">
                  <img 
                    src={product.image} 
                    alt={product.name} 
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 text-center">
            <a 
              href={gender === "women" ? "https://www.proerecta.cz/produkt/proerecta-women/" : "https://www.proerecta.cz/produkty/"}

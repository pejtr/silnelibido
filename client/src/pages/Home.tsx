...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-900 bg-[oklch(0.22_0.08_275)]">
      ...
      <Button
        className={`fixed bottom-24 md:bottom-8 right-4 md:right-8 rounded-full w-12 h-12 p-0 shadow-xl transition-all duration-300 z-50 bg-[#D32F2F] hover:bg-[#B71C1C] text-white ${
